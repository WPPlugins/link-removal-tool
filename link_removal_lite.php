    ...
    */
    ...
    function pclaen_all_posts_check() {
      // do something with the post data
        ...
        //$answer .= "<br /> Go <strong>PRO</strong> for <strong>FREE</strong>:&nbsp&nbsp&nbsp<a href='https://s3.amazonaws.com/link-removal-tool/LinkRemovalToolWildcard.zip' class='button-primary'>" . __( 'Download now', LINKREM_TEXT_DOMAIN ) . "</a><br />";
        return $answer;
    }
